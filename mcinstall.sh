...
case $architecture in    
    x86_64)    
        jdk_filename="OpenJDK17U-jdk_x64_linux_hotspot_17.0.8.1_1.tar.gz"    
        ;;    
    aarch64)    
        jdk_filename="OpenJDK17U-jdk_aarch64_linux_hotspot_17.0.8.1_1.tar.gz"    
        ;;    
    *)    
...
# 下载 JDK 安装包    
wget $jdk_url"/linux/"$jdk_filename -O "/tmp/$jdk_filename"    
...
# 输出安装完成信息    
echo "JDK 17 已成功安装到 /usr/local/java 目录"  
...
# 下载服务端    
wget https://example.com/paper1182.tar.gz -O paper1182.tar.gz  # 这里需要替换为实际的下载链接  
